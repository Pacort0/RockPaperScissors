            ...
            Image(painter = painterResource(id = R.drawable.piedra), //Piedra
                ...
                modifier = Modifier
                    ...
                    .clickable(enabled = siganJugando(puntuacionJugador, puntuacionMaquina)) {
                        ...
                        armaElegidaMaquina = numeroRandom() //La máquina elegirá un arma random entre 1 y 3

                        eleccionMaquina = textoArmaMaquina(armaElegidaMaquina) //Texto de elección del arma de la máquina
            ...
            Image(painter = painterResource(id = R.drawable.paper), //Papel
                ...
                modifier = Modifier
                    ...
                    .clickable(enabled = siganJugando(puntuacionJugador, puntuacionMaquina)) {
                        ...
                        armaElegidaMaquina = numeroRandom() //Se le asigna un arma aleatoria a la máquina
